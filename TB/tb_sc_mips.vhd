...
ARCHITECTURE struct OF MIPS_tbSS IS
   -- Internal signal declarations
   SIGNAL rst_tb_i           	: STD_LOGIC;
   SIGNAL clk_tb_i           	: STD_LOGIC;
   SIGNAL PBADDR_tb_i           : STD_LOGIC_VECTOR(7 DOWNTO 0);
